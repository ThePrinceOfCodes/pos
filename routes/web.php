...
Route::group(['middleware' => 'auth'], function () {
    ...
    // Receipts or stock
    Route::resource('inventory/stock', 'StockController')->except(['edit', 'update']);

    Route::get('inventory/stock/{stock}/finalize', ['as' => 'stock.finalize', 'uses' => 'StockController@finalize']);

    Route::get('inventory/stock/{stock}/product/add', ['as' => 'stock.product.add', 'uses' => 'StockController@addproduct']);

    Route::get('inventory/stock/{stock}/product/{receivedproduct}/edit', ['as' => 'stock.product.edit', 'uses' => 'StockController@editproduct']);
    Route::post('inventory/stock/{stock}/product', ['as' => 'stock.product.store', 'uses' => 'StockController@storeproduct']);

    Route::match(['put', 'patch'], 'inventory/stock/{stock}/product/{receivedproduct}', ['as' => 'stock.product.update', 'uses' => 'StockController@updateproduct']);

    Route::delete('inventory/stock/{stock}/product/{receivedproduct}', ['as' => 'stock.product.destroy', 'uses' => 'StockController@destroyproduct']);

    Route::resource('sales', 'SaleController')->except(['edit', 'update']);

    Route::get('sales/{user}/sales', ['as' => 'sales.showSales', 'uses' => 'SaleController@showSales']);
