...
class SaleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sales.index', compact('sales', 'cashiers', 'start_date', 'end_date'));
    ...
    public function show(Sale $sale)
    {
        ...
        return view('sales.show', ['sale' => $sale, 'paymentMethods' => $payment_methods]);
    }
    ...
    public function addproduct(Sale $sale)
    {
        ...
        return view('sales.addproduct', compact('sale', 'products', 'payment_methods'));
    }
