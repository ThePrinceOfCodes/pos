                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                           @hasrole('Manager|Admin|Developer') <a href="{{ route('clients.create') }}" class="btn btn-sm btn-primary">Add Client</a> @endhasrole
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            ...
                                            <form action="{{ route('clients.destroy', $client) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                                                <button type="button" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Delete Client" onclick="confirm('Deleting will delete all branch records and transactions') ? this.parentElement.submit() : ''">
