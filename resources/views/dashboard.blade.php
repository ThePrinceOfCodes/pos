                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                           @hasrole('Developer') <a href="{{ route('sales.create') }}" class="btn btn-sm btn-primary">New Sale</a>@endhasrole
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card card-tasks">
                ...
                <div class="row">
                        ...
                        <div class="col-4 text-right">
                            @hasrole('Developer')<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#transactionModal">
                                New Transaction
                            </button>
                            @endhasrole
                        </div>
