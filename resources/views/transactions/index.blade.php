                        ...
                        <div class="col-10">
                            <form class="form-inline" method="GET">
                                <div class="form-group">
                                    ...
                                    <select name="cashier" class="form-select form-control">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($transaction->transfer)
                                                <a href="#">ID {{ $transaction->transfer->id }}</a>
                                            @else
                                                Does not apply
                                            @endif
                                        </td>
                                        <td class="td-actions text-right">
                                            ...
                                            @elseif ($transaction->transfer_id)
                                                <a href="{{ route('transfer.index') }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="More details">
                                                    <i class="tim-icons icon-zoom-split"></i>
                                                </a>
                                            @else
