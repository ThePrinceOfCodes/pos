            ...
            <div class="card ">
                ...
                <div class="row">
                        ...
                        <div class="col-4 text-right">
                            @hasrole('Manager')<a href="{{ route('transfer.create') }}" class="btn btn-sm btn-primary">
                                Register Transfer
                            </a>@endrole
                        </div>
                    </div>
                        ...
                        <tbody>
                            @foreach ($transfers as $transfer)
                                <tr>
                                    ...
                                    <td>{{ format_money($transfer->sended_amount) }}</td>
                                    <td>{{ format_money($transfer->received_amount) }}</td>
