                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $category->products->sum('store') }}</td>
                                <td>{{ $category->products->sum('stock_defective') }}</td>
                                <td>{{ $category->products->sum('store_defective') }}</td>
                                <td>{{ number_format(round($category->products->avg('price'), 2)) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
