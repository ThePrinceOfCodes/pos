                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $receipt->products->sum('store') }}</td>
                                <td>{{ $receipt->products->sum('store_defective') }}</td>
                        ...
                        <tbody>
                            @foreach ($receipt->products as $received_product)
                                <tr>
                                    ...
                                    <td>{{ $received_product->store }}</td>
                                    <td>{{ $received_product->store_defective }}</td>
                                    <td>{{ $received_product->store + $received_product->store_defective }}</td>
