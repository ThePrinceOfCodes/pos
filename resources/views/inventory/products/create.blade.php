                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('stock_defective') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="stock_defective" id="input-stock_defective" class="form-control form-control-alternative" placeholder="Defective Stock" value="{{ old('stock_defective') ?? 0 }}" required readonly>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('store') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="store" id="input-store" class="form-control form-control-alternative" placeholder="Store" value="{{ old('store') }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('store_defective') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="store_defective" id="input-store_defective" class="form-control form-control-alternative" placeholder="Defective Store" value="{{ old('store_defective') ?? 0 }}" required>
