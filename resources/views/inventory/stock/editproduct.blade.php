@extends('layouts.app', ['page' => 'Edit Product', 'pageSlug' => 'stock', 'section' => 'inventory'])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('stock.product.update', ['stock' => $stock, 'receivedproduct' => $receivedproduct]) }}" autocomplete="off">
                            @csrf
                            @method('put')
